...
sub new {
    my ( $class, $parent) = @_;
    my $self = $class->SUPER::new( $parent, -1, 'About Wx::GUI::Spirograph' );

    my @label_property = ( [-1,-1], [-1,-1], &Wx::wxALIGN_CENTRE_HORIZONTAL );
    my $version = Wx::StaticText->new( $self, -1, $App::GUI::Spirograph::NAME . '    version '.$App::GUI::Spirograph::VERSION , @label_property);
    ...
    my $url     = Wx::HyperlinkCtrl->new( $self, -1, 'metacpan.org/pod/App::GUI::Spirograph', 'https://metacpan.org/pod/App::GUI::Spirograph' );
