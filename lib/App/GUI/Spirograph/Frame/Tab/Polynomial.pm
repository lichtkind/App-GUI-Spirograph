...
package App::GUI::Spirograph::Frame::Tab::Polynomial;
use base qw/Wx::Panel/;

use App::GUI::Spirograph::Frame::Panel::Monomial;
...
sub new {
    ...
    $self->{$_} = App::GUI::Spirograph::Frame::Panel::Monomial->new( $self, $_) for 1 .. $self->{'monomial_count'};
