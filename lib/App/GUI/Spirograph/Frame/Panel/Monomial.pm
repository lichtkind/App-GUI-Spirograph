...
package App::GUI::Spirograph::Frame::Panel::Monomial;
use v5.12;
use warnings;
use Wx;
...
sub new {
    ...
    $self->{'button_r'}  = App::GUI::Spirograph::Widget::SliderStep->new( $self, 160, 3, 0.3, 4, 2 );
    $self->{'button_i'}  = App::GUI::Spirograph::Widget::SliderStep->new( $self, 160, 3, 0.3, 4, 2, );
